...
export default function CreateSurvey() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-[#0764bf] to-[#1800ad] bg-clip-text text-transparent">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="shadow-lg">
          <CardBody className="p-6">
            <h3 className="text-2xl font-bold mb-4">Información Básica</h3>
