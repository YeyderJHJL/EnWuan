  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <CardBody className="p-6">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-full" style={{ backgroundColor: '#0764bf15' }}>
                <Building2 className="w-6 h-6" style={{ color: '#0764bf' }} />
              </div>
              <div>
                <p className="text-gray-600 text-sm">Total</p>
                <p className="text-3xl font-bold" style={{ color: '#0764bf' }}>{stats.total}</p>
              </div>
            </div>
          </CardBody>
        </Card>
          ...
          <CardBody className="p-6">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-full" style={{ backgroundColor: '#1800ad15' }}>
                <CheckCircle className="w-6 h-6" style={{ color: '#1800ad' }} />
              </div>
              <div>
                <p className="text-gray-600 text-sm">Activas</p>
                <p className="text-3xl font-bold" style={{ color: '#1800ad' }}>{stats.active}</p>
              </div>
            </div>
          </CardBody>
        </Card>
        ...
        <Card className="shadow-lg border-l-4" style={{ borderLeftColor: '#0764bf' }}>
          <CardBody className="p-6">
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-full" style={{ backgroundColor: '#0764bf15' }}>
                <Clock className="w-6 h-6" style={{ color: '#0764bf' }} />
              </div>
              <div>
                <p className="text-gray-600 text-sm">Pendientes</p>
                <p className="text-3xl font-bold" style={{ color: '#0764bf' }}>{stats.pending}</p>
              </div>
            </div>
          </CardBody>
        </Card>
      ...
      {pendingCompanies.length > 0 && (
        <Card className="shadow-lg mb-8 border-l-4" style={{ borderLeftColor: '#0764bf' }}>
          <CardBody className="p-6">
